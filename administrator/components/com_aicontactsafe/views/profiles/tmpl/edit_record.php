...
<script type="text/javascript" language="javascript">
	...
	function sortAll() {
		...
		for (i = 0; i < count_fields; i++) {
			...
			var up_link = '<a class="up_order_fields" href="javascript:void(0);" onclick="moveRow( -1, '+j+' )"><img style="border-width:0;" alt=" " src="<?php echo JUri::root(); ?>administrator/components/com_aicontactsafe/images/uparrow.png" /></a>';
			var down_link = '<a class="up_order_fields" href="javascript:void(0);" onclick="moveRow( 1, '+j+' )"><img style="border-width:0;" alt=" " src="<?php echo JUri::root(); ?>administrator/components/com_aicontactsafe/images/downarrow.png" /></a>';
			var fld = $('field_'+j);
	...
	function reset_notification() {
		$('required_field_notification').value='<?php echo JText::_('COM_AICONTACTSAFE_FIELDS_MARKED_WITH'); ?> %mark% <?php echo JText::_('COM_AICONTACTSAFE_ARE_REQUIRED'); ?>';
	}
</script>
	...
	<table id="profile">
                	...
                	<tr>
						<td>
							<a class="edit_other_fields" href="index.php?option=com_aicontactsafe&sTask=profiles&task=edit_contact&id=<?php echo $this->_id; ?>">
								<div class="edit_other_fields" style="text-align:center">
									<img class="edit_other_fields" style="border-width:0;" alt=" " src="components/com_aicontactsafe/images/contact.gif" /><br />
						...
						<td>
							<a class="edit_other_fields" href="index.php?option=com_aicontactsafe&sTask=profiles&task=edit_css&id=<?php echo $this->_id; ?>">
								<div class="edit_other_fields" style="text-align:center">
									<img class="edit_other_fields" style="border-width:0;" alt=" " src="components/com_aicontactsafe/images/css.gif" /><br />
						...
						<td>
							<a class="edit_other_fields" href="index.php?option=com_aicontactsafe&sTask=profiles&task=edit_email&id=<?php echo $this->_id; ?>">
								<div class="edit_other_fields" style="text-align:center">
									<img class="edit_other_fields" style="border-width:0;" alt=" " src="components/com_aicontactsafe/images/email.gif" /><br />
		...
		<tr>
			...
			<td class="value">
				...
				&nbsp;
				<input class="button btn" type="button" name="notification_reset" id="notification_reset" value="<?php echo JText::_('COM_AICONTACTSAFE_RESET'); ?>" onclick="reset_notification();" />
			</td>
		</tr>
		<tr>
			<td colspan="3" class="space">&nbsp;</td>
		...
		<tr>
			...
			<td class="space">&nbsp;</td>
			<td class="value">
				<table id="select_fields_table" style="border-width:0; padding:0; border-spacing:0;">
					<tbody id="select_fields_tbody">
						...
						<tr id="field_<?php echo $i; ?>">
							...
							<td>&nbsp;</td>
							<td>
								<table style="border-width:0; padding:2; boredr-spacing:0;">
									<tr id="order_row_<?php echo $i; ?>">
										...
										<td class="up_order_fields" id="up_order_fields_<?php echo $i; ?>">
											<?php if( $i_poz > 1 ) { ?>
											<a class="up_order_fields" href="javascript:void(0);" onclick="moveRow( -1, <?php echo $i; ?> )"><img style="border-width:0;" alt=" " src="<?php echo JUri::root(); ?>administrator/components/com_aicontactsafe/images/uparrow.png" /></a>
											<?php } else { echo '&nbsp;'; } ?>
										</td>
										<td class="down_order_fields" id="down_order_fields_<?php echo $i; ?>">
											<?php if( $i_poz < $no_poz ) { ?>
											<a class="down_order_fields" href="javascript:void(0);" onclick="moveRow( 1, <?php echo $i; ?> )"><img style="border-width:0;" alt=" " src="<?php echo JUri::root(); ?>administrator/components/com_aicontactsafe/images/downarrow.png" /></a>
											<?php } else { echo '&nbsp;'; } ?>
										</td>
									</tr>
								</table>
						...
						<tr id="fields_buttons">
							<td colspan="3" style="text-align:right;">
								<input class="btn" type="button" name="select_all" id="select_all" value="<?php echo JText::_('COM_AICONTACTSAFE_SELECT_ALL'); ?>" onClick="changeAll(true)" />
								&nbsp;&nbsp;&nbsp;
								<input class="btn" type="button" name="select_none" id="select_none" value="<?php echo JText::_('COM_AICONTACTSAFE_SELECT_NONE'); ?>" onClick="changeAll(false)" />
							</td>
							<td>&nbsp;</td>
							<td><input class="btn" type="button" name="sort_all" id="sort_all" value="<?php echo JText::_('COM_AICONTACTSAFE_SORT_ALL'); ?>" onClick="sortAll()" /></td>
						</tr>
					</tbody>
				</table>
