...
// function to initialize the variables used in the template
	function setVariables() {
		...
		if ( $this->_task == 'add' ) {
			...
			$this->published = 1;
			$this->contact_info = '<img style="margin-left: 10px; float: right; width:128; height:96;" alt="articles" src="images/stories/articles.jpg" /><div style="width: 150px; float: left;">Algis Info SRL<br />Str. Harmanului Nr.63<br />bl.1A sc.A ap.8<br />Brasov, Romania<br />500232<br /><a target="_blank" href="http://www.algisinfo.com/">www.algisinfo.com</a></div>';
