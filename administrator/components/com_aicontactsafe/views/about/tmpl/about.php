...
<table style="border-width:0; padding:0; border-spacing:0; width:100%;">
	<tr>
		<td style="width:50%; vertical-align:top;">
			<img src="<?php echo JUri::root().'administrator/components/com_aicontactsafe/images/logo.gif' ;?>" style="border-width:0;" alt=" " /><br/>
			<br/>
