	...
	function setVariables() {
		...
		switch($activate_artio) {
			case 0:
				...
				break;
			case 1:
				$this->activate_artio = '<button class="btn" onclick="document.getElementById(\'task\').value=\'activate_artio\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_ACTIVATE') . '</button>';
				break;
			case 2:
				$this->activate_artio = '<font color="#008000">' . JText::_('COM_AICONTACTSAFE_ARTIO_ACTIVATED') . '</font>';
				$this->activate_artio .= '&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'deactivate_artio\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_DEACTIVATE') . '</button>';
				break;
		}
		// check joomfish
		...
		switch($activate_joomfish) {
			case 0:
				...
				break;
			case 1:
				$this->activate_joomfish = '<button class="btn" onclick="document.getElementById(\'task\').value=\'activate_joomfish\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_ACTIVATE') . '</button>';
				break;
			case 2:
				$this->activate_joomfish = '<font color="#008000">' . JText::_('COM_AICONTACTSAFE_JOOMFISH_ACTIVATED') . '</font>';
				$this->activate_joomfish .= '&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'deactivate_joomfish\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_DEACTIVATE') . '</button>';
				break;
		}
		...
		switch($activate_falang) {
			case 0:
				...
				break;
			case 1:
				$this->activate_falang = '<button class="btn" onclick="document.getElementById(\'task\').value=\'activate_falang\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_ACTIVATE') . '</button>';
				break;
			case 2:
				$this->activate_falang = '<font color="#008000">' . JText::_('COM_AICONTACTSAFE_FALANG_ACTIVATED') . '</font>';
				$this->activate_falang .= '&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'deactivate_falang\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_DEACTIVATE') . '</button>';
				break;
		}
		...
		switch($checkAiContactSafeForm) {
			...
			case 1:
				...
				$this->aiContactSafeForm_button = '<font color="#FF0000">aiContactSafeForm ' . JText::_('COM_AICONTACTSAFE_OLDER_VERSION') . '</font>&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'reinstallAiContactSafeForm\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_UPGRADE') . '</button>&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'uninstallAiContactSafeForm\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_UNINSTALL') . '</button>';
				break;
			case 2:
				// aiContactSafeForm is installed and it is the last version
				$this->aiContactSafeForm_button = '<font color="#008000">aiContactSafeForm ' . JText::_('COM_AICONTACTSAFE_INSTALLED') . '</font>&nbsp;&nbsp;<button class="btn" onclick="document.getElementById(\'task\').value=\'uninstallAiContactSafeForm\';this.form.submit();">' . JText::_('COM_AICONTACTSAFE_UNINSTALL') . '</button>';
				break;
		}
