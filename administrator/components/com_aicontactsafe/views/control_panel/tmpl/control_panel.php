...
<fieldset class="adminform">
	<table id="control_panel">
		...
		<tr>
			...
			<td class="space">&nbsp;</td>
			<td class="value">
				<table style="border-width:0; padding:0; border-spacing:0; color:#FF0000">
				<?php
		...
		<tr>
			...
			<td class="space">&nbsp;</td>
			<td class="value">
				<?php echo JPATH_ROOT.DIRECTORY_SEPARATOR; ?><input class="textbox" type="text" name="upload_attachments" id="upload_attachments" value="<?php echo $this->upload_attachments; ?>"  />
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td class="space">&nbsp;</td>
			<td class="value">
				<button class="btn" onclick="document.getElementById('task').value='check_language';this.form.submit();"><?php echo JText::_('COM_AICONTACTSAFE_CHECK'); ?></button>
			</td>
		</tr>
		<tr>
			<td class="key">
		...
		<tr>
			...
			<td class="space">&nbsp;</td>
			<td class="value">
				<button class="btn" onclick="document.getElementById('task').value='confirm_delete_all';this.form.submit();" style="color:#FF0000;"><?php echo JText::_('COM_AICONTACTSAFE_DELETE_DATABASE_TABLES'); ?></button>&nbsp;&nbsp;&nbsp;<font color="#FF0000"><?php echo JText::_('COM_AICONTACTSAFE_DO_NOT_USE'); ?></font>
			</td>
		</tr>
	</table>
</fieldset>
