	...
	<table id="type">
		...
		<tr>
			...
			<td class="value">
				...
				<img src="<?php echo JUri::root();?>administrator/components/com_aicontactsafe/includes/fcp/sel.gif" onclick="showColorGrid2('color','color_sample');" style="cursor:pointer; border-width:0;" alt="<?php echo JText::_('COM_AICONTACTSAFE_SELECT_COLOR'); ?>" title="<?php echo JText::_('COM_AICONTACTSAFE_SELECT_COLOR'); ?>">
			</td>
		</tr>
		<tr>
			<td class="key">
