...
class AiContactSafeModelControl_panel extends AiContactSafeModelDefault {
	...
	function writeData() {
		...
		$att_folder = str_replace('/',DIRECTORY_SEPARATOR,$upload_attachments);
		$att_folder = str_replace('&#92;',DIRECTORY_SEPARATOR,$att_folder);
		$att_folder = JPATH_ROOT.DIRECTORY_SEPARATOR.$att_folder;
		...
		if (!JFolder::exists($att_folder)) {
			...
			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'index.html');
			$dest = JPath::clean($att_folder.DIRECTORY_SEPARATOR.'index.html');
			JFile::copy($src, $dest);

			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'htaccess'.DIRECTORY_SEPARATOR.'.htaccess');
			$dest = JPath::clean($att_folder.DIRECTORY_SEPARATOR.'.htaccess');
			JFile::copy($src, $dest);
		}
	...
	function deleteTablesAndFiles() {
		...
		$aicontactsafe_media_folder = JPATH_ROOT.DIRECTORY_SEPARATOR.'media'.DIRECTORY_SEPARATOR.'aicontactsafe';
	...
	function check_artio() {
		...
		$artio = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext');
		if (is_dir($artio)) {
			$return = 1;
			$com_aicontactsafe_php = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.php');
			$com_aicontactsafe_xml = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.xml');
	...
	function check_joomfish() {
		...
		$contentelements = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements');
		if (is_dir($contentelements)) {
			$return = 1;
			$aicontactsafe_contactinformations = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
			$aicontactsafe_fields = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
			$aicontactsafe_profiles = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
	...
	function check_falang() {
		...
		$contentelements = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements');
		if (is_dir($contentelements)) {
			$return = 1;
			$aicontactsafe_contactinformations = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
			$aicontactsafe_fields = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
			$aicontactsafe_profiles = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
			if (is_file($aicontactsafe_contactinformations) && is_file($aicontactsafe_fields) && is_file($aicontactsafe_profiles)) {
				$return = 2;
			}
		}
	...
	function activate_artio() {
		...
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'artio'.DIRECTORY_SEPARATOR.'com_aicontactsafe.php');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.php');
		JFile::copy($src, $dest);
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'artio'.DIRECTORY_SEPARATOR.'com_aicontactsafe.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.xml');
		JFile::copy($src, $dest);
	}
	...
	function deactivate_artio() {
		...
		$com_aicontactsafe = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.php');
		if (is_file($com_aicontactsafe)) {
			JFile::delete($com_aicontactsafe);
		}
		$com_aicontactsafe = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_sef'.DIRECTORY_SEPARATOR.'sef_ext'.DIRECTORY_SEPARATOR.'com_aicontactsafe.xml');
		if (is_file($com_aicontactsafe)) {
			JFile::delete($com_aicontactsafe);
		}
	}
	...
	function activate_joomfish() {
		...
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'joomfish'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
		JFile::copy($src, $dest);
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'joomfish'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
		JFile::copy($src, $dest);
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'joomfish'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_joomfish'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
		JFile::copy($src, $dest);
	}
	...
	function activate_falang() {
		...
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'falang'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_contactinformations.xml');
		JFile::copy($src, $dest);
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'falang'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_fields.xml');
		JFile::copy($src, $dest);
		$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'falang'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_falang'.DIRECTORY_SEPARATOR.'contentelements'.DIRECTORY_SEPARATOR.'aicontactsafe_profiles.xml');
		JFile::copy($src, $dest);
	}
	...
	function checkMessageSection() {
		...
		$db->setQuery( $query );
		$templates = $db->loadColumn(); //load###ResultArray();
		...
		foreach($templates as $template) {
			$indexFile = JPATH_ROOT.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.$template.DIRECTORY_SEPARATOR.'index.php';
			$fileTemplate = file_get_contents($indexFile);
	...
	function check_language() {
		...
		$lang = JFactory::getLanguage(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator');
		// check the administrator languages
		$languages = $lang->getKnownLanguages();
		foreach($languages as $lg) {
			$lang_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'language'.DIRECTORY_SEPARATOR.$lg['tag'].DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.ini');
			$source_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'languages'.DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.ini');
			...
			$lang_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'language'.DIRECTORY_SEPARATOR.$lg['tag'].DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.menu.ini');
			$source_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'languages'.DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.menu.ini');
			if (is_file($lang_file)) {
				if (is_file($source_file)) {
					JFile::delete($lang_file);
					JFile::copy($source_file, $lang_file);
			...
			$lang_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'language'.DIRECTORY_SEPARATOR.$lg['tag'].DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.sys.ini');
			$source_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'languages'.DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.sys.ini');
			if (is_file($lang_file)) {
				if (is_file($source_file)) {
					JFile::delete($lang_file);
					JFile::copy($source_file, $lang_file);
		...
		foreach($languages as $lg) {
			$lang_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'language'.DIRECTORY_SEPARATOR.$lg['tag'].DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.ini');
			$source_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'languages'.DIRECTORY_SEPARATOR.$lg['tag'].'.com_aicontactsafe.ini');
			if (is_file($lang_file)) {
				if (is_file($source_file)) {
					JFile::delete($lang_file);
					JFile::copy($source_file, $lang_file);
	...
	function checkAiContactSafeModule() {
		$return = 0;
		$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.xml');
		if (is_file($xml_file)) {
			...
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.xml');
			if (is_file($xml_file)) {
				$xml = JFactory::getXML( 'simple' );
				$xml->loadFile( $xml_file );
				$version = $xml->document->getElementByPath( 'version' );
	...
	function installAiContactSafeModule() {
		...
		$installed = $installer->install(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'mod_aicontactsafe');
		if ($installed) {
			// initialize the database
			$db = JFactory::getDbo();
	...
	function reinstallAiContactSafeModule() {
		...
		$xml_file_current = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.xml');
		$xml_file_last = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.xml');
		if (is_file($xml_file_current)) {
			JFile::delete($xml_file_current);
		}
		JFile::copy($xml_file_last, $xml_file_current);

		$php_file_current = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.php');
		$php_file_last = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'mod_aicontactsafe'.DIRECTORY_SEPARATOR.'mod_aicontactsafe.php');
	...
	function checkAiContactSafeForm() {
		$return = 0;
		if(version_compare(JVERSION, '1.6.0', 'ge')) {
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'content'.DIRECTORY_SEPARATOR.'aicontactsafeform'.DIRECTORY_SEPARATOR.'aicontactsafeform.xml');
		} else {
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'content'.DIRECTORY_SEPARATOR.'aicontactsafeform.xml');
		}
		if (is_file($xml_file)) {
			$xml = JFactory::getXML( 'simple' );
			$xml->loadFile( $xml_file );
			$version = $xml->document->getElementByPath( 'version' );
			$installed_version = $version->data();
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafeform'.DIRECTORY_SEPARATOR.'aicontactsafeform.xml');
			if (is_file($xml_file)) {
				$xml = JFactory::getXML( 'simple' );
				$xml->loadFile( $xml_file );
				$version = $xml->document->getElementByPath( 'version' );
	...
	function installAiContactSafeForm() {
		...
		if(version_compare(JVERSION, '1.6.0', 'ge')) {
			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafeform'.DIRECTORY_SEPARATOR.'xml'.DIRECTORY_SEPARATOR.'aicontactsafeform_1_6.ini');
		} else {
			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafeform'.DIRECTORY_SEPARATOR.'xml'.DIRECTORY_SEPARATOR.'aicontactsafeform_1_5.ini');
		}
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafeform'.DIRECTORY_SEPARATOR.'aicontactsafeform.xml');
		JFile::copy($src, $dest);
		// import the installer
		jimport('joomla.installer.installer');
		$installer = JInstaller::getInstance();
		$installed = $installer->install(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafeform');
		if ($installed) {
			// initialize the database
			$db = JFactory::getDbo();
	...
	function checkAiContactSafeLink() {
		$return = 0;
		if(version_compare(JVERSION, '1.6.0', 'ge')) {
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'content'.DIRECTORY_SEPARATOR.'aicontactsafelink'.DIRECTORY_SEPARATOR.'aicontactsafelink.xml');
		} else {
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'content'.DIRECTORY_SEPARATOR.'aicontactsafelink.xml');
		}
		if (is_file($xml_file)) {
			$xml = JFactory::getXML( 'simple' );
			$xml->loadFile( $xml_file );
			$version = $xml->document->getElementByPath( 'version' );
			$installed_version = $version->data();
			$xml_file = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafelink'.DIRECTORY_SEPARATOR.'aicontactsafelink.xml');
			if (is_file($xml_file)) {
				$xml = JFactory::getXML( 'simple' );
				$xml->loadFile( $xml_file );
				$version = $xml->document->getElementByPath( 'version' );
	...
	function installAiContactSafeLink() {
		...
		// copy the correct xml file
		if(version_compare(JVERSION, '1.6.0', 'ge')) {
			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafelink'.DIRECTORY_SEPARATOR.'xml'.DIRECTORY_SEPARATOR.'aicontactsafelink_1_6.ini');
		} else {
			$src = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafelink'.DIRECTORY_SEPARATOR.'xml'.DIRECTORY_SEPARATOR.'aicontactsafelink_1_5.ini');
		}
		$dest = JPath::clean(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafelink'.DIRECTORY_SEPARATOR.'aicontactsafelink.xml');
		JFile::copy($src, $dest);
		// import the installer
		jimport('joomla.installer.installer');
		$installer = JInstaller::getInstance();
		$installed = $installer->install(JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'plg_aicontactsafelink');
		if ($installed) {
			// initialize the database
			$db = JFactory::getDbo();
