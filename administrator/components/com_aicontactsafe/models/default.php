...
class AiContactSafeModelDefault extends JModelLegacy {
	...
	function getSessionStateFromRequest( $key, $request, $default = null, $type = 'none' ) {
		...
		$new_state = JFactory::getApplication()->input->get($request, $cur_state, $type);
	...
	function useUqField() {
		$uq_ini = JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'uq.ini';
		return file_exists($uq_ini);
	}

	function useCcField() {
		$cc_ini = JPATH_ROOT.DIRECTORY_SEPARATOR.'administrator'.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'cc.ini';
