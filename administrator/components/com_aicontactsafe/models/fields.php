...
class AiContactSafeModelFields extends AiContactSafeModelDefault {
	...
	function checkBeforeWrite($postData) {
		...
		$postData['field_values'] = JFactory::getApplication()->input->get('field_values', '', 'STRING');
		...
		$postData['field_label'] = JFactory::getApplication()->input->get('field_label', '', 'STRING');
		...
		$postData['field_label_message'] = JFactory::getApplication()->input->get('field_label_message', '', 'STRING');
