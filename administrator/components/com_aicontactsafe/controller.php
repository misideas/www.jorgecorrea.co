...
class AiContactSafeController extends JControllerLegacy {
	// component version
	var $_version = '2.0.21c.stable.j3.alfa';
	...
	function apply() {
		...
		if ($last_task['task'] == 'add') {
			...
			$last_id = JFactory::getApplication()->input->get('id', 0, 'INT');
		}
	...
	function getConfiguration() {
		...
		try {
			...
			throw new Exception(JText::_('COM_AICONTACTSAFE').' - '.JText::_('COM_AICONTACTSAFE_NOT_INSTALLED'));
		}
