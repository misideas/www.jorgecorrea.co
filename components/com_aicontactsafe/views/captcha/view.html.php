...
class AiContactSafeViewCaptcha extends AiContactSafeViewDefault {
	...
	function viewDefault() {
		...
		require_once( JPATH_ROOT.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'captcha'.DIRECTORY_SEPARATOR.'captcha.php' );
		// captcha parameters
