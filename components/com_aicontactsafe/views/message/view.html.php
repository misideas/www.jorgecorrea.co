	...
	function callCssFile($cssFile = '') {
		...
		if ($use_css) {
			...
			if (strlen($cssFile) > 0) {
				...
				$template_name = $this->_app->getTemplate();
				$tPath = JPATH_ROOT.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.$template_name.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'message'.DIRECTORY_SEPARATOR.$cssFile;
				if (JFile::exists($tPath)) {
