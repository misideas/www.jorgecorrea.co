...
class SimpleCaptcha {
    ...
    function __construct($config = array()) {
		...
		$folder_captcha_class = JPATH_SITE.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'includes'.DIRECTORY_SEPARATOR.'captcha';
		...
		if ( $config['use_random_letters'] == 1 ) {
			...
			if (is_null($this->wordsFile)) {
				$language_file = $folder_captcha_class.DIRECTORY_SEPARATOR.'words'.DIRECTORY_SEPARATOR.'en.txt';
				if ( strlen($config['lang']) > 0 && is_file($folder_captcha_class.DIRECTORY_SEPARATOR.'words'.DIRECTORY_SEPARATOR.$config['lang'].'.txt') ) {
					$language_file = $folder_captcha_class.DIRECTORY_SEPARATOR.'words'.DIRECTORY_SEPARATOR.$config['lang'].'.txt';
				}
