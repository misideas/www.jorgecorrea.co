...
$tPath = JPATH_ROOT.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.$template_name.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'com_aicontactsafe'.DIRECTORY_SEPARATOR.'message'.DIRECTORY_SEPARATOR.'load.gif';
...
$loading_img = '&nbsp;&nbsp;'.str_replace("'","\'",JText::_('COM_AICONTACTSAFE_PLEASE_WAIT')).'&nbsp;<img id="imgLoading" style="border-width:0;" src="'.$loadImage.'" alt=" "/>&nbsp;&nbsp;';
