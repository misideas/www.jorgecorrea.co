...
if ((($enable_like == 1) || ($enable_share == 1) || ($enable_twitter == 1) || ($enable_google == 1) || ($enable_in == 1))) {
    ...
    //LinkedIn button
    if ($enable_in == 1) {
        $data_counter_in = $params->get('data-counter_in', 'none');
        $data_showzero_in = $params->get('data-showzero_in', '0');
...
<a href="http://ordasoft.com/joomla-social-comments-and-sharing.html">Joomla Social Comments and Sharing - share and comment on Joomla site to social media: Facebook, Twitter, LinkedIn</a></noscript>
