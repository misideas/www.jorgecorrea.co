...
// Show Send Button
$fb_send_boolean = substr($fb_send, 2);
...
if ($fb_render == 'a.iframe') {
	...
	$mod_data = $rspsv_style . "<iframe src=\"//www.facebook.com/plugins/like.php?locale=" . $fb_locale . "&amp;href=" . $fb_url_dec . "&amp;width=" . $fb_width . "&amp;height=" . $fb_height . "&amp;colorscheme=" . $fb_color . "&amp;layout=" . $fb_layout . "&amp;action=" . $fb_verb_opt . "&amp;show_faces=" . $fb_faces_boolean . "&amp;send=" . $fb_send_boolean . "&amp;font=" . $fb_font_fam . "&amp;appId=" . $fb_appid . "\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:" . $fb_width . "px; height:" . $fb_height . "px;\" allowTransparency=\"true\"></iframe></div>";
